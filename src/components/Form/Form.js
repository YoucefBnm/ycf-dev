    ...
    <GooglMap className="google" lat={-34.397} lng={150.644} />
      <form className="form">
        <div className="form__group">
          ...
          <input type="text" placeholder="enter your name or company name ...." className="input input--border form__input" />
        </div>
        ...
        <div className="form__group">
          ...
          <input type="email" placeholder="enter your email" className="input input--border form__input" />
        </div>
        ...
        <div className="form__group">
          ...
          <textarea placeholder="enter your message" className="input input--border form__input" />
        </div>
