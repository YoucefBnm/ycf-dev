...
const socialLinks = [
  ...
  {
    href: 'https://linkedin.com/in/ussef-bnm-692392123',
  ...
  {
    href: 'https://www.facebook.com/BenmessabihYcf',
  ...
  {
    href: 'https://twitter.com/lbnm_yussef',
...
export default () =>{
  return (
    <footer className="footer">
      ...
      <div className="copyright">&copy; 2018 developed by Youcef Bnm.</div>
    </footer>
  );
}
